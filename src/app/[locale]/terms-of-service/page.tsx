...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Subterra Wiki",
    description: "Read the Terms of Service for Subterra Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Subterra Wiki",
      description: "Terms and conditions for using Subterra Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Subterra Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Subterra Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Subterra Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Subterra Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Subterra". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Active codes and reward guides</li>
              <li>Ore locations and layer guides</li>
              <li>Pickaxe and backpack upgrade paths</li>
              <li>Ability Card and Chrono Shard strategies</li>
              <li>Weapon crafting and boss tactics</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Subterra Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation and Polyworks Studio or the official developers of Subterra. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Subterra Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and Polyworks Studio and/or the developers of Subterra. We use such
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> Roblox game availability and game updates may change without notice. We are not responsible for demo access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, SUBTERRA WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Subterra Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@subterra.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@subterra.wiki</a>
            </p>
            <p>
