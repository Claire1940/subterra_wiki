...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Subterra Wiki',
    description: 'Copyright and intellectual property information for Subterra Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Subterra Wiki',
      description: 'Copyright and intellectual property information for Subterra Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Subterra Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Subterra Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Subterra Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Polyworks Studio</strong> - Creators of the Subterra game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Subterra</strong> - Trademark of the game developers</li>
              <li><strong>Subterra Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Subterra Wiki.
            </p>
            ...
            <p>
              ...
              Subterra Wiki<br />
              Email: <a href="mailto:dmca@subterra.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@subterra.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Subterra Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Subterra Wiki (subterra.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@subterra.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@subterra.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@subterra.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@subterra.wiki</a>
            </p>
            <p>
